<template>
    <form @submit.prevent="submit">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Иван Федоров">
            <small v-if="errors && errors.name" id="nameHelp" class="form-text text-danger">{{ errors.name[0] }}</small>
        </div>
        <div class="form-group">
            <label for="phone">Телефон</label>
            <input type="text" class="form-control" id="phone" name="phone" aria-describedby="phoneHelp" placeholder="+7 (___) ___-__-__">
            <small v-if="errors && errors.email" id="phoneHelp" class="form-text text-danger">{{ errors.email[0] }}</small>
        </div>
        <div class="form-group">
